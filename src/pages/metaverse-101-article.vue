  ...
  <section class="metaverse-101-article">
    <metaverse-page>
      <div>
        ...
        <span class="mt-10">
          <p>
            The future of technological innovation. <br>
            The forthcoming iteration of the internet. <br>
            The next big thing.
          </p>
          ...
          <p>
            Most likely, you have had some sort of interaction with some sort of iteration of the metaverse. But do you
            really understand what it is or what it could become?
          </p>

          <p>
            There is no consensual definition of the metaverse, but many point to Matthew Ball, author of the 2022 book,
            “The Metaverse: And How It Will Revolutionize Everything.” His definition reads, “A massively scaled and
            interoperable network of real-time rendered 3D virtual worlds that can be experienced synchronously and
            persistently by an effectively unlimited number of users with an individual sense of presence, and with
          ...
          <p>
            Budding metaverse experiences that meet some, but not all, of Ball’s definition can be grouped under “extended
            reality,” or XR. Extended reality is a colloquial umbrella term that includes virtual reality, augmented reality,
            mixed reality and everything in between. Experts believe extended reality experiences and technology will play
            a part in building the immersion demanded by the metaverse.
          </p>

          <p>
            Meanwhile, virtual reality is the closest to a metaverse experience, allowing people to engage in an immersive
            environment that simulates real world senses. For example, National Geographic’s Explore VR <a href="https://www.oculus.com/experiences/quest/2046607608728563/">gives</a> people the
            chance to “discover the world without ever leaving home” by climbing ice shelves in Antarctica or witnessing
            mummy worship in Machu Picchu.
          </p>

          <p>
            Augmented reality, on the other hand, superimposes computer-generated experiences onto the real world, as
            opposed to a complete immersion. These experiences are typically accessed through devices like a mobile phone
            or tablet instead of a headset. Pokémon Go is perhaps one of the most popular augmented reality experiences,
            <a href="https://pokemongolive.com/en/">facilitating</a> people to search for Pokémons by holding up their mobile phones to the real world, as if they
            were placed in specific locations.
          </p>
          ...
          <p>
            ...
            virtual reality headsets and hand controllers. A virtual reality headset allows the wearer to visualize and
            interact with a 360-degree virtual experience from an active - as opposed to passive - first-person point of view.
          </p>

          <p>
            Through the display, the wearer sees and feels their surroundings change to whichever experience they choose,
            as opposed to a 2D screen where they can clearly distinguish between the virtual and real world. Headsets are
            equipped with tools like surround sound systems and head movement trackers that accordingly adjust the visualization
            of the virtual world, just as perception would change as people move around in the real world.
          </p>

          <p>
            Some advanced virtual reality headsets, like Meta Platforms’ Meta Quest Pro, even have facial tracking tools,
            allowing the natural expressions of the wearer to be reflected in their avatar. Avatars are a virtual manifestation
            of the user and the “being” they become to interact with virtual worlds. Different experiences allow for different
            levels of customizations, but many platforms typically allow the user to design their avatar to reflect their own physical traits.
          </p>

          <p>
            Many headsets are also coupled with hand controllers, which resemble joysticks. They add an additional sensory
            layer, allowing the wearer to use their hands to pick up and interact with objects in the virtual world. For
            example, a user drawing a bow and arrow in a battle field experience could feel the tension of the string
            through the controllers.
          </p>

          <p>
            From the Microsoft HoloLens to the HTC Vive Pro 2, almost every major technology company has their own virtual
            reality headset with their own experiences and specializations. They are not cheap, with price points ranging
            from $300 to $1499. <a href="https://www.counterpointresearch.com/global-xr-ar-vr-headsets-market-share/">According</a> to Counterpoint Research, a global technology market analysis company based in
            Hong Kong, Meta Platforms’ headsets accounted for 66% of the market, followed by Pico and DPVR at 11% and 9%
            respectively. Some of these headsets may be critical to accessing and navigating a fully realized metaverse.
          </p>

          <p>
            “[The metaverse is] an iterative extension of the internet,” said Nelson. “People are looking at the new
            technologies that will afford our access to it. We used to access the internet through our computers, then
            our laptops and eventually our phones. Now, we’re looking at trying to access that data through wearables
            in environments.”
          </p>

          <p>
            Regardless of present developments, some people still claim the metaverse is merely a buzzword, an attempt
            to excite an unsuspecting public, while others cite early models of budding systems that warrant a look at
            its future.
          </p>

          <p>
            “I’m in an engineering school,” said Pierre-Louis Lemaire, a master’s student studying applied mathematics
            and engineering in France. He authored and published an article on Medium, titled,, “Why The Metaverse is
            a Threat to Human Society - Not an Opportunity.” “It’s kind of interesting because a lot of people are potentially
            going to work for that type of product. Most people actually don’t talk about the metaverse. I feel like it’s
            something that we make big because it’s really controversial. But in reality, apart from people that are really
            excited for it and talk about it a lot - they make tiny amounts but [make] a lot of noise - in my circles,
            people are not that interested.”
          </p>

          <p>
            But the metaverse continues to influence a wide range of industries, from entertainment to education. Roblox,
            a virtual gaming company, <a href="https://blog.roblox.com/2021/11/introducing-roblox-community-fund/">invested</a> $10 million into developing immersive experiences for educational purposes,
            such as allowing students to virtually explore the Colosseum. Warner Music Group <a href="https://www.wmg.com/news/sandbox-partners-warner-music-group-create-music-themed-world-metaverse-36116">announced</a> a partnership with
            The Sandbox, another virtual gaming company, to create a music theme park of sorts to host virtual concert
            experiences, allowing fans and artists to engage in ways they could not in the real world.
          </p>

          <p>
            It doesn’t end there. In 2022, South Korea’s Ministry of Science and ICT <a href="https://doc.msit.go.kr/SynapDocViewServer/viewer/doc.html?key=dcc6cbad6011442e8caf03550a0e7ea7&convType=html&convLocale=ko_KR&contextPath=/SynapDocViewServer/">announced</a> an investment of ₩223.7
            billion, or approximately $168 billion, into what they call a “metaverse ecosystem,” committed to the development
            of an expanded virtual world. Countries like China and India are pursuing similar ventures.
          </p>

          <p>
            Every day, it seems like a new organization is announcing its metaverse venture, whether that is developing
            clinical training programs in immersive reality or creating computer-generated offices to boost remote work
            experiences - although all these experiences still remain isolated virtual or augmented reality experiences,
          ...
          <p>
            ...
            unlocking powerful opportunities for human interaction and connection, becoming mainstays in daily life. But
            it also mirrors the dangers, which is why the metaverse continues to be a controversial subject. If what the
            future holds is a dinner with relatives from across the world in an immersive, computer-generated environment
            that feels incredibly real, it also holds risks of data privacy, technological addiction and a warped sense of reality.
          </p>
          ...
          <p>
            Historically, humans have come to rely on technology as tools to solve some of the world’s most pressing issues,
            seemingly so crucial that the inherent risks of the technology is usually justified as long as they are relatively
            mitigated. The metaverse is no exception, with futuristic plans being discussed about how the metaverse will
            fundamentally advance critical fields like health care. Some experts warn against that mentality.
          </p>
