<template>
<section class="metaverse-health-case">
  <metaverse-page>
    <h1>A different type of healthcare: immersive, adaptive, reactive - and life changing </h1>

    <p>
      It wasn’t easy for Samantha Haspel to fight through her cancer treatment. In March 2018, the women’s health nurse
      practitioner and midwife from Salisbury, North Carolina, had been diagnosed with lymphoma and had gone through several
      unsuccessful rounds of chemotherapy. She was struggling emotionally and in a dark place. It was a chance interaction
      with virtual reality, during a routine radiation appointment, when things started to look up.
    </p>

    <p>
      “One day, I walked into the radiation lobby and they had a chair set up with a television screen, a thing of wipes,
    ...
    <p>
      “The health care system everywhere is incredibly overstretched,” said Jane Thomason, a thought leader in technology
      for social impact and an international health care professional based in Queensland, Australia. “We don’t have enough
      health workers anywhere, we have this growing burden of chronic disease and similar things, which are incredibly
      expensive and creating a big burden on countries, but they’re also not amenable to the traditional health care system,
      which is built around hospital-based care. How can you use technology in the metaverse to be able to provide care differently?”
    </p>
    ...
    <p>
      “It’s another way for people to do their training,” said Jeffrey Jacobson, the extended reality lead of Immersive
      Design Systems. “With [virtual reality], you can’t touch anything. But you can learn tactical spatial reasoning,
      you can learn how to move in the space, how to take action on the larger scale, you can practice your teamwork,
      you can practice emotional regulation.”
    </p>

    <p>
      Most people will experience extended reality through patient care. As telemedicine became increasingly commonplace
      during the coronavirus pandemic, the benefits of improved accessibility were clear. If patients cannot physically
      travel to a hospital, for whatever reason, that does not mean they should be denied care, and the metaverse could
      help facilitate that.
    </p>

    <p>
      “If you also think about the elderly and the disabled, they can’t leave their homes,” said Thomason. “They’re going
      to be able to go into a metaverse environment, seek care. It’s time to really open up worlds for people who can’t
      leave their homes but who would like to experience different things and who suffer from isolation and so forth.”
    </p>
    ...
    <p>
      “We’ve made all these games and activities that a clinician gets to use how they best see fit,” said Megan Christiana,
      business development manager at Neuro Rehab VR. “Once you put a patient into a virtual environment, they’re not looking
      down and seeing their leg anymore that they insist does not bend. You put them on a beach, for example, and the therapist
      can magically bend their leg the whole way. They’re distracted, they aren’t even realizing this is happening.”
    </p>
    ...
    <p>
      “I think the issues regarding privacy of data and protection of data aren’t any different within [virtual reality]
      as they are in digital health or social media,” said Robert Fine, executive director of the International Virtual
      Reality Healthcare Association, an organization comprised of technology companies, teaching hospitals, universities
      and others involved in virtual reality health care, based in Washington D.C.. “I think the same concerns and how to
      alleviate them apply. There’s nothing special about healthcare except there’s some more stringent legal requirements
      in terms of how the data is managed, ensuring the particular data cannot be linked to an individual patient.”
    </p>

    <p>
      Right now, individual hospitals and technology companies have their own unique platforms that tackle specific health
      care issues. Experts predict a future where computer-generated, immersive reality becomes quintessential to the health
      care industry is foreseeable, but it remains a ways away.
    </p>
